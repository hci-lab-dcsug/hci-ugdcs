const projectsData = [
  {
    title: "A Chatbot for Maternal Care in Akan",
    description:
      "This project focuses on the development of a sophisticated chatbot designed to support maternal care, encompassing both prenatal and postnatal needs. By leveraging the power of large language models (LLMs),\
         the chatbot provides mothers and caregivers with personalized advice, vital health information, and actionable tips in their native languages. Recognizing the linguistic diversity of underserved communities, \
  ...
  },
  {
    ...
    description:
      "This project addresses the challenge of creating robust automatic speech recognition (ASR) systems for non-standard Akan speech,\
        a language spoken in various dialects across Ghana and neighboring regions. By leveraging state-of-the-art ASR models such as Whisper,\
        the initiative seeks to improve the accuracy and efficiency of recognizing and transcribing spoken Akan in its diverse forms.\
        The primary goal of this work is to enhance accessibility and bridge the gap between technology and underserved communities that rely \
        on low-resource languages. Developing ASR systems capable of understanding non-standard speech patterns will enable seamless communication with technology,\
